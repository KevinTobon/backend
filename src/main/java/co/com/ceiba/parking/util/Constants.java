...
public class Constants {
	...
	public static final LocalDateTime EXIT_DATE_TEST_SECONS = LocalDateTime.of(2018, 12, 13, 11, 01, 01);
	public static final LocalDateTime EXIT_DATE_TEST_MINUTES = LocalDateTime.of(2018, 12, 12, 8, 19, 10);
	public static final LocalDateTime EXIT_DATE_TEST_HOURS = LocalDateTime.of(2018, 12, 12, 11, 21, 0);
